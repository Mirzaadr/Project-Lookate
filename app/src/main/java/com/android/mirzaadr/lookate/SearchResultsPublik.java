...
public class SearchResultsPublik extends ActionBarActivity {

    private static String url_search = "http://himatipa.tp.ugm.ac.id/lookate/publik_cari.php";
    ...
    static String TAG_MAKANAN = "publik";
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(SearchResultsPublik.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Cari Pelayanan Publik");
        ...
        protected void onPostExecute(Void args) {
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent in = new Intent(getApplicationContext(), detilpublik.class);
            ...
            adapter = new ListViewAdapter(SearchResultsPublik.this, arraylist);
