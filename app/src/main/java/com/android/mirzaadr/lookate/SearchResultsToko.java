...
public class SearchResultsToko extends ActionBarActivity {

    private static String url_search = "http://himatipa.tp.ugm.ac.id/lookate/toko_cari.php";
    ...
    static String TAG_MAKANAN = "toko";
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(SearchResultsToko.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Cari Toko");
        ...
        protected void onPostExecute(Void args) {
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent in = new Intent(getApplicationContext(), detiltoko.class);
            ...
            adapter = new ListViewAdapter(SearchResultsToko.this, arraylist);
