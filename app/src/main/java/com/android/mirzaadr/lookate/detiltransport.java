 ...
 */
public class detiltransport extends Activity {
    // Declare Variables
    ...
    private static final String url_search = "http://himatipa.tp.ugm.ac.id/lookate/transport_detail.php";
    static String TAG_TOKO = "transport";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detiltransport);
        map = (Button) findViewById(R.id.transport_map);
    ...
    private class DownloadJSON extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(detiltransport.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Informasi Transportasi");
