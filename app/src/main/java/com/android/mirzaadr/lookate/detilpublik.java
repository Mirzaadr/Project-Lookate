 ...
 */
public class detilpublik extends Activity {
    // Declare Variables
    ...
    private static final String url_search = "http://himatipa.tp.ugm.ac.id/lookate/publik_detail.php";
    static String TAG_TOKO = "publik";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detilpublik);
        map = (Button) findViewById(R.id.public_map);
    ...
    private class DownloadJSON extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(detilpublik.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Informasi Pelayanan Publik");
