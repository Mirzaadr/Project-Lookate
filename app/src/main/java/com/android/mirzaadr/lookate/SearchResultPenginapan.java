...
public class SearchResultPenginapan extends ActionBarActivity {

    private static String url_search = "http://himatipa.tp.ugm.ac.id/lookate/tpt_tinggal_cari.php";
    ...
    static String TAG_MAKANAN = "tpt_tinggal";
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(SearchResultPenginapan.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Cari Penginapan");
        ...
        protected void onPostExecute(Void args) {
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent in = new Intent(getApplicationContext(), detilpenginapan.class);
            ...
            adapter = new ListViewAdapter(SearchResultPenginapan.this, arraylist);
