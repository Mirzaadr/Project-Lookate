...
public class SearchResultTrans extends Activity {

    private static String url_search = "http://himatipa.tp.ugm.ac.id/lookate/transport_cari.php";
    ...
    static String TAG_MAKANAN = "transport";
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(SearchResultTrans.this);
            // Set progressdialog title
            mProgressDialog.setTitle("Cari Transportasi");
        ...
        protected void onPostExecute(Void args) {
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent in = new Intent(getApplicationContext(), detiltransport.class);
            ...
            adapter = new ListViewAdapter(SearchResultTrans.this, arraylist);
